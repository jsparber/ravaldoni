...
async function create_select_bike_preference_page(association, recovery_date) {
	...
	html.push(
		...
		"<br>",
		"In piu' puoi indicare il numero massimo di bici che vorresti ottenere.",
		"<br>",
		'E\' consigliato di indicare <b>Mi interessa molto</b> per alemeno il numero di bici che vorresti,',
		"<br>",
	...
	html.push(
		...
		'<br>',
		'<div>',
		`<label for="number_of_needed_bikes">Il numero massimo di bici che vorresti (questo e' il massimo numero di bici che ti veranno assegnati):</label>`,
		'<br>',
